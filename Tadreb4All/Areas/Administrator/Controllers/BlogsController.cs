...
namespace Tadreb4All.Areas.Administrator.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public BlogsController(TadrebDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BlogId,BlogTitle,BlogDesc,UserName,BlogImg,PubDate,IsPublished")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogId,BlogTitle,BlogDesc,UserName,BlogImg,PubDate,IsPublished")] Blog blog)
        {
            if (id != blog.BlogId)
            {
                return NotFound();
