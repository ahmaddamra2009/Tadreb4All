...
namespace Tadreb4All.Areas.Administrator.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(TadrebDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuName,MenuUrl,IsActive")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuName,MenuUrl,IsActive")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
